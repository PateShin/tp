...
public class CommandTestUtil {
    ...
    public static final int VALID_ID_BOB = 240010;
    public static final int VALID_ID_AMY = 240011;
    ...
    public static final String VALID_YEAR_JOINED_AMY = "2024";
    public static final String VALID_YEAR_JOINED_BOB = "2024";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withId(240001).build();
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        PayBack expectedPayBack = new PayBack(actualModel.getPayBack());
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredPersonList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedPayBack, actualModel.getPayBack());
