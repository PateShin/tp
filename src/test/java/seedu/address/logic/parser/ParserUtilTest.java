...
public class ParserUtilTest {
    ...
    public void parseTags_collectionWithValidTags_returnsTagSet() throws Exception {
        ArrayList<Tag> actualTagSet = ParserUtil.parseTags(Arrays.asList(VALID_TAG_1, VALID_TAG_2));
        ArrayList<Tag> expectedTagSet = new ArrayList<>(Arrays.asList(new Tag(VALID_TAG_1), new Tag(VALID_TAG_2)));
