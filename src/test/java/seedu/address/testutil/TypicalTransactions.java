...
public class TypicalTransactions {
    ...
    public static final Transaction TRANSACTION_1 = new TransactionBuilder().withDateTime("01/01/2024 12:00")
            .withEmployeeId(240001).withAmount("10.00").withDescription("Lunch").build();
    public static final Transaction TRANSACTION_2 = new TransactionBuilder().withDateTime("01/01/2024 13:00")
            .withEmployeeId(240002).withAmount("20").withDescription("Claims").build();
    public static final Transaction TRANSACTION_3 = new TransactionBuilder().withEmployeeId(240003)
